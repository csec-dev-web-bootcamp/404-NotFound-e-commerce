/** * eslint-disable @next/next/no-img-element * * @format */ /** @format */ 
"use client";
...
export default function UsersPage() {
  return (
    <div className="flex flex-col gap-5 w-full">
      {" "}
      <PageTitle title="Users" /> <DataTable columns={columns} data={data} />{" "}
    </div>
  );
}
