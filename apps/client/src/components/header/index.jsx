...
const Header = () => {
  ...
  return (
    <header className="my-8 min-h-80 w-full flex justify-center">
      <div className=" rounded-md border-[1px] border-slate-300 w-11/12 shadow-lg dark:bg-slate-700 dark:text-white">
        <div className="flex h-full  flex-col justify-evenly items-center">
          <h1 className="text-4xl font-extrabold font-mono"  >
            Explore with X-those E-commerce platform
          </h1>
          <div className="flex w-2/5">
            <input
              ...
              name=""
              id=""
              placeholder="What you are looking for? type it here..."
              className="w-full p-2 px-4 text-slate-700 rounded-lg outline-none border-2 border-slate-800"
            />
          </div>
